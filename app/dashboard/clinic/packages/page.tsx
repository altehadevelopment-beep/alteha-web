...
export default function PublishPackagePage() {
    ...
    const [items, setItems] = useState<MedicalPackageItem[]>([
        { itemName: 'Servicio Médico', description: 'Evaluación inicial', quantity: 1, unitPrice: 50 },
    ]);
        ...
        return (
            <div className="space-y-10 font-outfit max-w-6xl mx-auto pb-20">
                <header className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                    <div>
                        <Link href="/dashboard/clinic" className="inline-flex items-center gap-2 text-slate-500 hover:text-alteha-turquoise transition-colors mb-4 font-medium">
                                ...
                                <section className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-1 gap-6">
                                        ...
                                        <div className="grid grid-cols-2 gap-6">
                                            ...
                                            />
                                            <Input label="Tipo de Institución" defaultValue="Clínica" disabled />
                                        </div>
