...
export default function ClinicAdLandingPage() {
    ...
    if (!ad) {
        return (
            <div className="max-w-2xl mx-auto py-24 text-center space-y-4 font-outfit">
                ...
                <Link href="/dashboard/clinic" className="text-emerald-600 font-black hover:underline">
                    Volver al dashboard
                </Link>
            </div>
        );
    ...
    return <AdLanding ad={ad} backHref="/dashboard/clinic" />;
}
