...
// POST /api/doctor-invitations/{id}/respond — el médico acepta (con honorarios) o rechaza.
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        const response = await fetch(`${API_BASE}/doctor-invitations/${params.id}/respond`, {
            method: 'POST',
            headers: {
