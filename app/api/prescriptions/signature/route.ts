...
// POST /api/prescriptions/signature — upload/replace the doctor's signature image (multipart).
export async function POST(request: NextRequest) {
    try {
        ...
        const response = await fetch(`${API_BASE}/prescriptions/signature`, {
            method: 'POST',
            headers: {
...
// GET /api/prescriptions/signature — current signature URL for the authenticated doctor.
