...
// POST /api/clinic-invitations/[id]/respond — accept (with fee) or reject an invitation.
export async function POST(request: NextRequest, { params }: { params: { id: string } }) {
    try {
        ...
        const response = await fetch(`${API_BASE}/clinic-invitations/${params.id}/respond`, {
            method: 'POST',
            headers: {
