...
export async function GET(request: NextRequest) {
    try {
        ...
        const response = await fetch(`${API_BASE}/doctor-additional-files/custom-upload`, {
            method: 'GET',
            headers: {
                'Accept': '*/*',
...
export async function POST(request: NextRequest) {
    try {
        ...
        const url = new URL(`${API_BASE}/doctor-additional-files/custom-upload`);
        ...
        // Build new form data with just the file
