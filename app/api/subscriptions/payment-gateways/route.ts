...
// GET — configuración pública de pasarelas (comercio Binance de Alteha + pk de Stripe; sin secretos)
export async function GET(request: NextRequest) {
    try {
        ...
        const response = await fetch(`${API_BASE}/subscriptions/payment-gateways`, {
